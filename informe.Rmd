...
ggplot(vinos_argentina, aes(x = puntos, y = precio)) +
  ...
  ggtitle("Vinos de Argentina con Puntos >= 95")



```

Promedio de puntos de los vinos de Argentina
...
Promedio de Precios de los vinos de Argentina
...
```
Vemos que Argentina, tiene un buen promedio en puntaje de vinos, pero está muy por encima del precio promedio de la lista, por lo cual no encontramos vinos baratos y con buen puntaje mayoro igual a 95.
